...
Original file is located at
    https://colab.research.google.com/drive/1DG5VXQRL_MeyZpq7-yE9_FelHLwLig8o
"""
...
def file_from_google_drive(file_id, destination):
    URL = f'https://drive.google.com/uc?id={file_id}'
    gdown.download(URL, destination, quiet=False)

# Google Drive file IDs
movies_file_id = '1G2SDqc251ZjDaiQ6aLV-o80HAmgofNTe'
similarity_file_id = '1DG5VXQRL_MeyZpq7-yE9_FelHLwLig8o'
...
if not os.path.isfile(movies_file_path):
    file_from_google_drive(movies_file_id, movies_file_path)

if not os.path.isfile(similarity_file_path):
    file_from_google_drive(similarity_file_id, similarity_file_path)
